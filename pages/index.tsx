...
const IndexPage = ({data}) => (
  <Layout>
    <div className="doc-page">
      ...
      <p>
        If you think a document should be added to the database, please open an issue on <a href="https://github.com/jaredgorski/data.civdocs.us" target="_blank">Github</a>.
      </p>
