  ...
  <>
    <nav className="doc__nav">
      <ul className="list-inline text-align-right margin-0">
        ...
        <li><Link href={`/docs/${documentParam}`}><a className="color-link">index</a></Link></li>
        {next_section_index ? <li><Link href={`/docs/${documentParam}/${next_section_index}`}><a className="color-link">next</a></Link></li> : null}
      </ul>
    </nav>
